...
<script lang="ts" setup>
  ...
  const styles = tv({
    base: "focus:bg-accent focus:text-accent-foreground data-[highlighted]:ring-border relative flex w-full cursor-pointer select-none items-center rounded-sm py-2 pl-3 pr-8 text-sm outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[highlighted]:ring-1",
  });
</script>

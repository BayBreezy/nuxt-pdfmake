...
<script lang="ts" setup>
  ...
  const styles = tv({
    base: "bg-background focus-visible:ring-primary/40 fixed bottom-0 left-0 right-0 z-50 mt-24 flex h-auto max-h-[95%] flex-col rounded-t-[10px] border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset",
  });
</script>

...
<style>
  ...
  .dataTables_wrapper .dt-buttons {
    ...
    button {
      @apply bg-background text-muted-foreground hover:bg-muted focus-visible:ring-ring focus-visible:ring-offset-background inline-flex h-9 items-center gap-2 whitespace-nowrap rounded-md border px-3 text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2;
    }
  }
  ...
  */
  ...
  .dataTables_wrapper .dataTables_length {
    label {
      ...
      select {
        @apply border-border bg-background focus:border-primary focus-visible:border-input focus-visible:ring-ring focus-visible:ring-offset-background h-9 w-[70px] cursor-pointer rounded-md border px-2 py-1 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 sm:text-sm;
      }
    }
  }
  ...
  .dataTables_wrapper .dataTables_filter {
    label {
      ...
      input {
        @apply border-border bg-background focus:border-primary focus:ring-ring focus:ring-offset-background focus-visible:border-input h-9 w-full rounded-md border px-2 py-1 transition focus:outline-none focus:ring-2 focus:ring-offset-2 sm:text-sm;
      }
    }
  }
  ...
  .dt-search {
    ...
    label {
      @apply text-muted-foreground inline-flex cursor-pointer items-center gap-2 text-sm font-normal;
    }
    input {
      @apply border-border bg-background focus:border-primary focus:ring-ring focus:ring-offset-background focus-visible:border-input h-9 w-full rounded-md border px-2 py-1 transition focus:outline-none focus:ring-2 focus:ring-offset-2 sm:text-sm md:w-[50%] lg:w-[250px];
    }
  }
  ...
  table.dataTable > tbody > tr.child ul.dtr-details > li {
    @apply hover:bg-muted border-b p-3 px-7;
  }
  ...
  div.dtr-modal div.dtr-modal-display {
    @apply bg-background absolute left-1/2 top-1/2 z-[102] max-h-[80%] w-full max-w-screen-sm -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-md border p-4 pb-0 md:px-7 md:py-4 md:pb-0 lg:max-h-[90%];
  }
  ...
  div.dtr-modal div.dtr-modal-close {
    @apply bg-muted/10 hover:bg-muted absolute right-2 top-2 z-[10] inline-flex size-6 cursor-pointer items-center justify-center rounded-md;
  }
  ...
  div.dtsb-searchBuilder button.dtsb-button {
    @apply bg-background text-muted-foreground focus-visible:ring-ring focus-visible:ring-offset-background relative box-border inline-flex h-9 cursor-pointer select-none items-center justify-center overflow-hidden text-ellipsis whitespace-nowrap rounded-md border px-3 py-2 text-sm font-normal focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2;
  }
  ...
  div.dtsb-searchBuilder div.dtsb-group div.dtsb-criteria select.dtsb-value {
    @apply border-input bg-background focus:border-primary focus:ring-ring focus:ring-offset-background focus-visible:border-input rounded-md border text-sm transition focus:outline-none focus:ring-2 focus:ring-offset-2;
  }
  ...
  .dt-button-collection {
    @apply relative;
    [role="menu"] {
      @apply bg-background before:text-muted-foreground/70 absolute -left-20 top-7 flex min-w-[200px] flex-col rounded-md border py-2 shadow before:mx-2 before:mb-2 before:text-xs before:content-['Select_columns'];
      button {

    ...
    >
      <div class="flex items-center justify-between gap-3">
        <slot name="rowsSelected" :table="table">
          <div v-if="showSelect" class="text-muted-foreground whitespace-nowrap text-sm">
            <span>
      ...
      <div class="flex items-center justify-between gap-3">
        <slot :table="table" name="page">
          <div
            class="text-foreground flex items-center justify-center whitespace-nowrap text-sm font-medium"
          >

...
description: Add running page headers and footers with page numbers to multi-page PDFs using the Nuxt pdfMake module.
---
...
<!-- automd:file src="../../app/components/content/Examples/HeaderFooterExample.vue" code  -->

```vue [HeaderFooterExample.vue]
<template>

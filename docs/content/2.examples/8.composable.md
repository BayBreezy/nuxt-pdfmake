---
title: Composable
description: Learn how to use the usePDFMake composable and QR codes in the Nuxt pdfMake module.
---
...
<!-- automd:file src="../../app/components/content/Examples/ComposableExample.vue" code  -->

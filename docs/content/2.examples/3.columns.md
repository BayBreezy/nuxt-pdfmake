---
title: Columns
description: Learn how to use columns in your PDFs using the Nuxt pdfMake module.
---

::prose-alert{icon="heroicons:book-open" title="Columns Docs" description="Visit https://pdfmake.github.io/docs/0.1/document-definition-object/columns/ for more information."}
::

## Preview

This example demonstrates how to use columns in your PDFs using the Nuxt pdfMake module.

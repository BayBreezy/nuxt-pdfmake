---
title: Images
description: Learn how to embed and display images in a PDF using the Nuxt pdfMake module.
---
...
<!-- automd:file src="../../app/components/content/Examples/ImageExample.vue" code  -->

```vue [ImageExample.vue]
<template>

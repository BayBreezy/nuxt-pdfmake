---
title: Lists
description: Learn how to create lists in your PDFs using the Nuxt pdfMake module.
---

## Preview

This example demonstrates how to create lists in your PDFs using the Nuxt pdfMake module.

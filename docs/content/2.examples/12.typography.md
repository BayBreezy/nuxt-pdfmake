---
title: Typography
description: Explore text decoration, font sizes, color, character spacing, superscript, subscript, line height, and alignment in the Nuxt pdfMake module.
---
...
<!-- automd:file src="../../app/components/content/Examples/TypographyExample.vue" code  -->

```vue [TypographyExample.vue]
<template>

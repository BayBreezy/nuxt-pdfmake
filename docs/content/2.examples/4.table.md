---
title: Table
description: Learn how to create a table in a PDF using the Nuxt pdfMake module.
---

## Preview

This example demonstrates how to create a table in a PDF using the Nuxt pdfMake module.
